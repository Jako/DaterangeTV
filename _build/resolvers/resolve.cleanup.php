    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            if ($oldPackage && $oldPackage->compareVersion('1.4.0', '>')) {
                $cleanup = [
                    'core' => [
                        'components/daterangetv/lexicon/en/tvrenders.inc.php',
                        'components/daterangetv/lexicon/de/tvrenders.inc.php'
                    ]
                ];
                cleanupFolders($modx, $corePath, $assetsPath, $cleanup, 'DaterangeTV', '1.4.0');
                cleanupPluginEvents($modx, 'DaterangeTV', ['OnDocFormRender']);
            }
            $success = true;
            break;
